...
const ParentDashboard: React.FC = () => {
    ...
    if (!student) {
        return (
            <div className="text-center py-12 flex flex-col items-center justify-center opacity-40">
                ...
                <p className="text-sm font-bold text-slate-500">Buscando información del estudiante asociado...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8">
            <h1 className="text-2xl font-black text-slate-800 dark:text-white tracking-tight">Panel de Padre - <span className="text-primary">{student?.name}</span></h1>
